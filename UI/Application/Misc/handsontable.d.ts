declare namespace _Handsontable {
  ...
  class Core {
    ...
    addHook(key: string, callback: ((isForced: boolean) => void) | ((changes: Array<any>, source: string) => void) | ((e: Event, coords?: object, elemet?: Element) => void) | ((e: Event, coords?: object, elemet?: Element) => void)[]): void;
